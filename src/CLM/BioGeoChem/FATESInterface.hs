...
-- documented stub functions at every integration point.
--
-- Ported from:
...
module CLM.BioGeoChem.FATESInterface
  ...
  , defaultHLMFATESInterface
    -- * Stub function signatures (documented no-ops)
  , fatesInit
  , fatesToClmSunfrac
  , fatesToClmBtran
...
-- | Main FATES daily dynamics driver. STUB.
