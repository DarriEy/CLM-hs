...
| 14 | Glacier surface mass balance — **MODULE DONE**: `GlacierSurfaceMassBalanceMod` ported + 7 unit tests; driver integration (istice column + snow-capping flux) pending data | L | module: unit-validated; in-pipeline: No |
